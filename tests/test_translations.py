...
STRINGS_JSON = BASE_DIR / "custom_components" / "assist_canonicalizer" / "strings.json"
TRANSLATIONS_DIR = BASE_DIR / "custom_components" / "assist_canonicalizer" / "translations"
...
def test_translation_key_order(translation_file):
    ...
    integrations allow omitting root sections in localizations, Assist Canonicalizer
    requires full alignment to ensure deterministic synchronization and clean diffs.
    """
