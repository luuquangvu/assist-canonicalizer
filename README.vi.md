...
> Phiên bản phụ thuộc benchmark: `Python` 3.14.6, `homeassistant` 2026.9.0, `hassil` 3.12.0, `home-assistant-intents` 2026.8.28.

| Chế độ         | Assist Canonicalizer | HassIL trực tiếp | Mức tăng (%p) | Khôi phục | Ngăn hồi quy | Nhận diện sai | Dự phòng | P50 ms | P95 ms |
| :------------- | -------------------: | ---------------: | ------------: | --------: | -----------: | ------------: | -------: | -----: | -----: |
| `managed_live` |            **93.6%** |            50.2% |         +43.4 |       265 |            3 |          0.3% |     6.1% |   85.6 |  258.4 |
...
| :------- | -------------------: | ---------------: | ------------: | --------: | -----------: | ------------: | -------: | -----: | -----: |
| EN       |            **97.5%** |            54.2% |         +43.3 |        52 |            0 |          0.0% |     2.5% |   67.1 |  247.5 |
| DE       |            **91.0%** |            48.4% |         +42.6 |        52 |            1 |          0.8% |     8.2% |  120.7 |  241.6 |
| FR       |            **92.4%** |            49.6% |         +42.9 |        51 |            1 |          0.0% |     7.6% |   99.4 |  305.2 |
| NL       |            **89.9%** |            48.8% |         +41.1 |        53 |            1 |          0.8% |     9.3% |   71.7 |  236.5 |
| VI       |            **97.5%** |            50.0% |         +47.5 |        57 |            0 |          0.0% |     2.5% |   48.4 |  188.1 |
