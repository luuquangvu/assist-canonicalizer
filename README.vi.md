...
> Phiên bản phụ thuộc benchmark: `Python` 3.14.7, `homeassistant` 2026.9.3, `hassil` 3.12.1, `home-assistant-intents` 2026.8.28.

| Chế độ         | Assist Canonicalizer | HassIL trực tiếp | Mức tăng (%p) | Khôi phục | Ngăn hồi quy | Nhận diện sai | Dự phòng | P50 ms | P95 ms |
| :------------- | -------------------: | ---------------: | ------------: | --------: | -----------: | ------------: | -------: | -----: | -----: |
| `managed_live` |            **93.3%** |            49.3% |         +43.9 |       268 |            3 |          0.3% |     6.4% |   84.8 |  244.3 |
...
| Ngôn ngữ | Assist Canonicalizer | HassIL trực tiếp | Mức tăng (%p) | Khôi phục | Ngăn hồi quy | Nhận diện sai | Dự phòng | P50 ms | P95 ms |
| :------- | -------------------: | ---------------: | ------------: | --------: | -----------: | ------------: | -------: | -----: | -----: |
| EN       |            **95.8%** |            50.0% |         +45.8 |        55 |            0 |          0.0% |     4.2% |   66.9 |  235.4 |
| DE       |            **91.0%** |            48.4% |         +42.6 |        52 |            1 |          0.8% |     8.2% |  119.3 |  241.9 |
| FR       |            **92.4%** |            49.6% |         +42.9 |        51 |            1 |          0.0% |     7.6% |  101.8 |  295.0 |
| NL       |            **89.9%** |            48.8% |         +41.1 |        53 |            1 |          0.8% |     9.3% |   69.3 |  225.6 |
| VI       |            **97.5%** |            50.0% |         +47.5 |        57 |            0 |          0.0% |     2.5% |   49.3 |  185.5 |
